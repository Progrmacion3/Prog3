...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <table>
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtMatricula" MaxLength="7" runat="server"></asp:TextBox>
            </td>
            <td>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtAño" MaxLength="4" runat="server" onkeydown="return (!(event.keyCode>=65) && event.keyCode!=32);"></asp:TextBox>
            </td>
            <td>
