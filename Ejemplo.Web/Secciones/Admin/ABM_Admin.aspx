    ...
    <table>
        ...
        <tr>
            <td colspan="3" align="left">
                ...
                <asp:Button ID="btnActualizar" Text="Modificar" runat="server" OnClick="btnActualizar_Click" />
            </td>
        </tr>
        <tr>
            <td>
                ...
                <asp:GridView ID="grdAdmin" Width="93%" runat="server" AutoGenerateColumns="true" ViewStateMode="Enabled" CellPadding="10" ForeColor="#333333"
                    OnRowDeleting="grdAdmin_RowDeleting" AutoGenerateSelectButton="true" AutoGenerateDeleteButton="true" OnSelectedIndexChanging="grdAdmin_SelectedIndexChanging"
