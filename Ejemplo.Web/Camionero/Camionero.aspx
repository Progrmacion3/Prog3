    ...
    <table>
        ...
        <tr>
            <td colspan="3" align="left">
                <asp:Button ID="btnAgregar" Text="Agregar" runat="server" OnClick="btnAgregar_Click_Camionero" />
                <asp:Button ID="btnModificar" Text="Modificar" runat="server" Visible ="false" OnClick="btnModificar_Click_Camionero" />
                <asp:Button ID="btnEliminar" Text="Eliminar" runat="server" Visible ="false" OnClick="btnEliminar_Click_Camionero" />
                 <asp:Button ID="btnCancelar" Text="Cancelar" runat="server" Visible ="false" OnClick="btnCancelar_Click_Camionero" />
            </td>
        </tr>
